...
<div class="container">
  ...
  <HorizontalCard
    ...
    title='Exercism'
    description="Très bien pour les débutant.e.s car les exercices sont relus par des mentors. Il y a près de 100 exercices en Ruby, par niveaux et avec des thématiques (hash, math, boucle...)"
  />
  ...
  <HorizontalCard
    ...
    title='Coderbyte'
    description="Pour les débutant.e.s, des exercices d'algorithmie vraiment faciles (contrairement à codewars) donc tu peux prendre confiance progressivement."
  />
  ...
  <HorizontalCard
    ...
    description="Recensement d'exercices en ruby par niveau (débutant.e, intermédiaire, expert.e)."
  />
</div>
