...
<div class="container">
  <HorizontalCard
    ...
    title='Paris.rb'
    description="avec les canaux de discussion suivants: #dejs (pour quand on pouvait se retrouver déjeuner), #help (pour demander de l'aide technique), #jobs et #jobs-ruby-and-rails pour trouver des offres d'emploi."
  />
</div>
